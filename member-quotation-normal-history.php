                ...
                <div class="member-body">
                    ...
                    <div class="btn-toolbar pull-elft" role="toolbar">
                        ...
                        <div class="btn-group active">
                            <a href="member-quotation.php">ขอใบเสนอราคาทั่วไป</a>
                        </div>
                    </div>
                    <br/><br/>
                    <div class="tab">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="active"><a href="member-quotation-normal-history.php">ใบเสนอราคาที่ได้รับแล้ว</a></li>
                            <li><a href="member-quotation-normal-reject.php">ใบเสนอราคาที่ไม่สำเร็จ</a></li>
                        </ul>
                                ...
                                <div class="panel-list no-margin quotation-list">
                                    <div class="head">
                                        <div class="row">
                                            ...
                                            <div class="col col-sm-3">ราคา</div>
                                    ...
                                    <div class="body">
                                        <div class="list">
                                            <div class="row">
                                                ...
                                                <div class="col col-sm-3">
                                                    <div class="text-desc">
                                                        <label class="hidden-desktop">ราคา</label>
                                                        <p>24,500 บาท</p>
                                                    </div>
                                                </div>
