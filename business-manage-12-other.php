                                ...
                                <div role="tabpanel" class="tab-pane active">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-body font-medium">
                                            ...
                                            <br/>
                                            <a href="business-manage-12-view.php" class="font-link font-blue" target="_blank">ดูตัวอย่างการแสดงโปรโฟล์ธุรกิจ</a>
                                        </div>
                                    </div>
                                    <div class="panel panel-default">
                                            ...
                                            <div class="col-md-8 col-sm-12">
                                                <div class="tab style-2 ">
                                                    <ul class="nav nav-tabs">
                                                        <li class="active"><a href="#tab-info1" aria-controls="tab-info1" role="tab" data-toggle="tab">ธุรกิจบริการอื่น ๆ</a></li>
                                                    </ul>
