...
<html>
    ...
    <body>
                                ...
                                <div role="tabpanel" class="tab-pane active">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-body font-medium">
                                            ...
                                            <br/>
                                            <a href="business-manage-10-view.php" class="font-link font-blue" target="_blank">ดูตัวอย่างการแสดงโปรโฟล์ธุรกิจ</a>
                                        </div>
                                    </div>
                                    <div class="panel panel-default">
                                            ...
                                            <div class="col-md-8 col-sm-12">
                                                <div class="tab style-2 ">
                                                    <ul class="nav nav-tabs">
                                                        <li class="active"><a href="#tab-info1" aria-controls="tab-info1" role="tab" data-toggle="tab">วิทยากร</a></li>
                                                    </ul>
                                                            ...
                                                            <div class="panel panel-default">
                                                                ...
                                                                <div class="panel-heading has-option">
                                                                    <div class="text-icon for-list is-middle mobile-no-middle no-margin">
                                                                        ...
                                                                        <h3 class="font-semibold no-margin pull-left">ข้อมูลของวิทยากร</h3>
                                                                    </div>
                                                                    <button type="button" class="btn btn-default btn-sm btn-edit hidden-mobile" data-dismiss="modal" data-toggle="modal" data-target="#modal-lecturer">
                                                                        <div class="text-icon">
                                                                ...
                                                                <div class="panel-body">
                                                                    <div class="form-group">
                                                                        <div class="row">
                                                                            <div class="col-sm-12">
                                                                                <p class="font-semibold no-margin">ประเภทความถนัดของวิทยากร</p>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <div class="text-icon for-list is-middle">
                                                                                    <i class="m-icon m-icon-check"></i>
                                                                                    <span>Incentive Specialist</span>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                                <div class="text-icon for-list is-middle">
                                                                                    <i class="m-icon m-icon-check"></i>
                                                                                    <span>Conference Professional</span>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                                <div class="text-icon for-list is-middle">
                                                                                    <i class="m-icon m-icon-check"></i>
                                                                                    <span>MICE Coach</span>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <div class="row">
                                                                            <div class="col-sm-12">
                                                                                <p class="font-semibold no-margin">ประสบการณ์ (ปี)</p>
                                                                                <div>10 ปี</div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <div class="row">
                                                                            <div class="col-sm-12">
                                                                                <p class="font-semibold no-margin">ประเภทภาษา</p>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                                <div class="text-icon for-list is-middle">
                                                                                    <i class="m-icon m-icon-check"></i>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="row">
                                                                            <div class="col-sm-12">
                                                                                <p class="font-semibold no-margin">ต้นสังกัดของวิทยากร</p>
                                                                                <p>-</p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="btn-box mobile-text-center hidden-desktop">
                                                                        <button type="button" class="btn btn-default btn-sm btn-edit" data-dismiss="modal" data-toggle="modal" data-target="#modal-lecturer">
                                                                            <div class="text-icon">
                                                                                <i class="m-icon m-icon-edit"></i>
                                                                                <span>แก้ไขข้อมูล</span>
                                                                            </div>
                                                                ...
                                                                <div class="panel-body">
                                                                    ...
                                                                    <button type="button" data-dismiss="modal" data-toggle="modal" data-target="#modal-lecturer" class="btn btn-lg btn-block btn-default btn-add-option">
                                                                        <div class="text-icon is-middle">
                                                                            <i class="m-icon m-icon-plus"></i>
        ...
        <div class="modal fade modal-checkbox" id="modal-lecturer" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header pd-40">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><i class="m-icon m-icon-close-blue"></i></button>
                        <h3 class="no-margin font-semibold">ข้อมูลของวิทยากร</h3>
                    </div>
                    <div class="modal-body pd-40">
                        <form action="?lecturer=true" method="post">
                            <div class="form-group">
                                <label class="font-semibold mobile-font-16">ประเภทความถนัดของวิทยากร</label>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="checkbox">
                                            <input type="checkbox" id="ml-type1">
                                            <label for="ml-type1">Engineering</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="checkbox">
                                            <input type="checkbox" id="ml-type2">
                                            <label for="ml-type2">Human Resource</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="checkbox">
                                            <input type="checkbox" id="ml-type3">
                                            <label for="ml-type3">Management</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="checkbox">
                                            <input type="checkbox" id="ml-type4">
                                            <label for="ml-type4">Finance</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="checkbox">
                                            <input type="checkbox" id="ml-type5">
                                            <label for="ml-type5">Marketing</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="checkbox">
                                            <input type="checkbox" id="ml-type6">
                                            <label for="ml-type6">Economics</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="checkbox">
                                            <input type="checkbox" id="ml-type7">
                                            <label for="ml-type7">Team Building</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="checkbox">
                                            <input type="checkbox" id="ml-type8">
                                            <label for="ml-type8">Meeting Professional</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="checkbox">
                                            <input type="checkbox" id="ml-type9">
                                            <label for="ml-type9">Incentive Specialist</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="checkbox">
                                            <input type="checkbox" id="ml-type10">
                                            <label for="ml-type10">Conference Professional</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="checkbox">
                                            <input type="checkbox" id="ml-type11">
                                            <label for="ml-type11">Exhibition Professional</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="checkbox">
                                            <input type="checkbox" id="ml-type12">
                                            <label for="ml-type12">Venue Management Professional</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="checkbox">
                                            <input type="checkbox" id="ml-type13">
                                            <label for="ml-type13">MICE Coach</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="checkbox">
                                            <input type="checkbox" id="ml-type14">
                                            <label for="ml-type14">Train the trainers</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="checkbox">
                                            <input type="checkbox" id="ml-type15">
                                            <label for="ml-type15">Sustainable Event Professional</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="checkbox">
                                            <input type="checkbox" id="ml-type16">
                                            <label for="ml-type16">Presentation Skills</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="checkbox">
                                            <input type="checkbox" id="ml-type17">
                                            <label for="ml-type17">Social Media</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="checkbox">
                                            <input type="checkbox" id="ml-type18">
                                            <label for="ml-type18">International</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="checkbox">
                                            <input type="checkbox" id="ml-type19">
                                            <label for="ml-type19">Communication Skills</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="checkbox">
                                            <input type="checkbox" id="ml-type20">
                                            <label for="ml-type20">Management Skills</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="checkbox">
                                            <input type="checkbox" id="ml-type21">
                                            <label for="ml-type21">Strategic Focus</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="checkbox">
                                            <input type="checkbox" id="ml-type22">
                                            <label for="ml-type22">Sale & Business Development </label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="checkbox">
                                            <input type="checkbox" id="ml-type23">
                                            <label for="ml-type23">General</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="checkbox">
                                            <input type="checkbox" id="ml-type-other">
                                            <label for="ml-type-other">
                                                <input type="text" class="form-control border-under no-padding" placeholder="เพิ่มความถนัดอื่นๆ">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <label class="font-semibold mobile-font-16">ประสบการณ์ (ปี)</label>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" data-mask="000" placeholder="ระบุประสบการณ์">
                                    </div>
                                </div>
                                <p class="required">กรุณากรอกข้อมูล</p>
                            </div>
                            <div class="form-group">
                                <label class="font-semibold mobile-font-16">ประเภทภาษา</label>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="checkbox">
                                            <input type="checkbox" id="ml-lang1">
                                            <label for="ml-lang1">ภาษาไทย</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="checkbox">
                                            <input type="checkbox" id="ml-lang2">
                                            <label for="ml-lang2">ภาษาอังกฤษ</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="checkbox">
                                            <input type="checkbox" id="ml-lang3">
                                            <label for="ml-lang3">ภาษาจีน</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="checkbox">
                                            <input type="checkbox" id="ml-lang4">
                                            <label for="ml-lang4">ภาษาฝรั่งเศส</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="checkbox">
                                            <input type="checkbox" id="ml-lang-other">
                                            <label for="ml-lang-other">
                                                <input type="text" class="form-control border-under no-padding" placeholder="เพิ่มภาษาอื่นๆ">
                                            </label>
                                        </div>
                                    </div>
                                    <p class="required">กรุณาเลือกข้อมูล</p>
                            ...
                            <div class="form-group">
                                <label class="font-semibold mobile-font-16">ต้นสังกัดของวิทยากร</label>
                                <input type="text" class="form-control" placeholder="ระบุต้นสังกัดของวิทยากร">
                                <p class="required">กรุณากรอกข้อมูล</p>
                            </div>
                            <div class="btn-box text-right mobile-text-center">
                                <button type="submit" class="btn btn-md btn-blue-linear font-semibold btn-minwidth">บันทึกข้อมูล</button>
