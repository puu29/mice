                ...
                <div class="member-body">
                    ...
                    <div class="tab">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="active"><a href="member-quotation-reject.php">ใบเสนอราคาที่ไม่สำเร็จ</a></li>
                        </ul>
                                ...
                                <div class="panel-list no-margin quotation-list">
                                    <div class="head">
                                        <div class="row">
                                            ...
                                            <div class="col col-sm-2">วันที่ขอใบเสนอราคา</div>
                                            <div class="col col-sm-2">รูปแบบการขอ</div>
