                            ...
                            <form action="" method="post" onsubmit="return check_data();" enctype="multipart/form-data">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        <p class="no-margin">ท่านสามารถเลือกกลุ่มธุรกิจเฉพาะเพื่อการค้นหาที่่ตรงกับความต้องการของท่านให้เร็วยิ่งขึ้น โดยในหน้าถัดไป ระบบจะแสดงเฉพาะกลุ่มธุรกิจที่ท่านได้ทำการเลือกไว้เท่านั้น</p><br/>
                                        <div class="col-3">
                                        ...
                                        <hr/>
                                        <p class="font-blue"><b>ข้อมูลสำหรับออร์แกไนเซอร์</b></p>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
